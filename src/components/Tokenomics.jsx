...
const Tokenomics = () => {
    return (
        ...
        <section className=' position-relative bg-black'>
                ...
                <div className=' row  '>
                        <div className='col-12 col-lg-5 d-flex justify-content-center flex-column align-items-center align-items-lg-start'>
                    ...
                    <div className='col-12  col-lg-7 pt-4'>
                        <div className=' d-flex flex-wrap flex-lg-nowrap gap_17'>
                            <div className='orange_box max_width_296 w-100'>
                        ...
                        <div className='padding_top_18 padding_left_148'>
                            <div className='orange_box max_width_296 w-100 justify-content-center'>
